...
public class WavFile
{
	...
	public static void main(String[] args)
	{
		try
		{
				WavFile readWavFile = openWavFile(new File(Utils.FILE_PATH_LOAD));
				readWavFile.display();
				...
				WavFile writeWavFile = newWavFile(new File(Utils.FILE_PATH_SAVE), numChannels, numFrames, validBits, sampleRate);
			...
			WavFile writeWavFile2 = newWavFile(new File("out2.wav"), 1, 10, 23, 44100);
			double[] buffer2 = new double[10];
			writeWavFile2.writeFrames(buffer2, 10);
			writeWavFile2.close();
		}
		catch (Exception e)
		{
